...
Config_init() {
  ...
  ;; MAIN FONT SIZE HERE is NOT the large font size:

  Config_fontSize          := 12
  Config_largeFontSize     := 60
  ...
  Config_rule_#19  := "SpotifyMainWindow;.*;;1;0;0;1;1;0;"
  Config_rule_#19 := "SpotifyMainWindow;.*;;1;0;0;1;1;0;"
  Config_rule_#20 := "Chrome_WidgetWin_1;.*Discord.*;;1;1;0;0;1;0;"
  Config_ruleCount := 20
...
!r::Monitor_setWindowTag(4)
!t::Monitor_setWindowTag(5)
!y::Monitor_setWindowTag(6)
!u::Monitor_setWindowTag(7)
!i::Monitor_setWindowTag(8)
!o::Monitor_setWindowTag(9)
